    ...
    <div class="container">
        ...
        <div class="story-block">
            ...
            <div class="story-content">
                <h3>Our Beginning</h3>
                <p>
                    Welcome to Ziggy Natural, where passion meets purity. Born from a love for the finest tea leaves and
                    coffee beans,
                    our journey began in the lush hills where nature's best secrets are kept.
                </p>
                <p>
                    We believe that a great cup of tea or coffee is more than just a beverage; it's a moment of
        ...
        <div class="story-block reverse">
            ...
            <div class="story-content">
                ...
                <p>
                    That's why we source only organic, ethically grown ingredients that are good for you and good for
                    the planet.
                    Our dedicated team travels the globe to bring you unique blends that tantalize your taste buds.
                </p>
                <p>
                    From the misty peaks to your cup, we ensure quality in every sip. Every product is carefully
                    selected and tested
        ...
        <div class="products-showcase">
            <div class="product-showcase-card">
                ...
                <div class="product-showcase-content">
                    <h3>PREMIUM TEA</h3>
                    <p>Hand-picked Ceylon tea from the finest plantations, offering rich flavors and aromatic blends.
                    </p>
                    <a href="products" class="btn-dark">EXPLORE →</a>
                </div>
            </div>
            <div class="product-showcase-card">
                <div class="product-showcase-image">
