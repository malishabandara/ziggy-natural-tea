...
<?php if (isset($_GET['msg'])): ?>
    <div
        style="max-width: 1000px; margin: 2rem auto; padding: 1rem 2rem; background: #d4edda; color: #155724; border-radius: 4px; text-align: center;">
...
<section style="padding: 5rem 2rem; max-width: 1000px; margin: 0 auto;">
    ...
    <div class="contact-container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 4rem;">
        ...
        <div class="contact-info">
            <h3>Get in Touch</h3>
            <p style="margin-bottom: 2rem; color: #666;">Have a question about our products? We'd love to hear from you.
            </p>

            <div style="margin-bottom: 1.5rem;">
                <strong><i class="fas fa-map-marker-alt" style="color: var(--secondary-color); width: 25px;"></i>
                    Address:</strong><br>
                Ziggy Natural (Pvt) Ltd<br>128/B, Main Street<br>Urubokka, Sri Lanka
            </div>

            <div style="margin-bottom: 1.5rem;">
                <strong><i class="fas fa-phone" style="color: var(--secondary-color); width: 25px;"></i>
                    Phone:</strong><br>
                +94 77 499 5669
            </div>

            <div style="margin-bottom: 1.5rem;">
                <strong><i class="fas fa-envelope" style="color: var(--secondary-color); width: 25px;"></i>
                    Email:</strong><br>
            ...
            <form action="admin/actions" method="POST">
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <input type="text" name="name" class="form-control"
                        style="width: 100%; padding: 1rem; border: 1px solid #ddd; border-radius: 4px;" required>
                </div>
                <div class="form-group" style="margin-bottom: 1.5rem;">
                ...
                <div class="form-group" style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="message" class="form-control" rows="5"
                        style="width: 100%; padding: 1rem; border: 1px solid #ddd; border-radius: 4px; font-family: inherit;"
                        required></textarea>
                </div>
